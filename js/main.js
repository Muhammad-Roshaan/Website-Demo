...
let currentIndex = 0;
let cloneCount = 3; // Number of items to clone for seamless looping
...
let interval = setInterval(moveCarousel, 2000); // Move every 2 seconds
